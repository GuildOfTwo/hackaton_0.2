...
Влад Булоусов - Тимлид проекта, frontend разработчик

Кирилл Чугунов - Frontend разработчик

Александр Березин - Frontend разработчик

[**Руслан Газиев**](https://github.com/gazievri) - Frontend разработчик

Андрей Сергеев - Backend разработчик
