...
**Onboardy** - это сервис, который автоматизирует и упрощает процесс онбординга и адаптации новых сотрудников. Проект выполнен в рамках хакатона [Лидеры цифровой трансформации Краснодарский край](https://i.moscow/lct/krasnodar). Рабочий прототип сервиса доступен по [ссылке](https://onboardy.top61.ru).
...
<details><summary>Диаграмма таблиц реляционной СУБД</summary>
    fffff
</details>

Диаграмма таблиц реляционной СУБД
Детально ознакомиться с особеностями работы и возможностями backend части вы можете по ссылке. 
